        ...
        try {
            ...
            while (rs.next()) {
                ...
                ResultSet resultSet = statement.executeQuery("SELECT users.userID, \n" +
                        "       watched_movies.movieID AS watchedMovieID, \n" +
                        "       movies.name AS movieName,\n" +
                        "       movies.year AS movieYear,\n" +
                        "       movies.genre AS movieGenre,\n" +
                        "       movies.rating AS movieRating\n" +
                        "FROM users\n" +
                        "LEFT JOIN watched_movies ON users.userID = watched_movies.userID\n" +
                        "LEFT JOIN movies ON watched_movies.movieID = movies.movieID\n" +
